  ...
  describe('Web Platform', () => {
    ...
    describe('getItem', () => {
      ...
      it('should throw error when localStorage throws', async () => {
        ...
        jest.spyOn(localStorage, 'getItem').mockImplementation(() => { throw error })
    ...
    describe('setItem', () => {
      ...
      it('should throw error when localStorage throws', async () => {
        const error = new Error('Storage error')
        jest.spyOn(localStorage, 'setItem').mockImplementation(() => { throw error })
    ...
    describe('removeItem', () => {
      ...
      it('should throw error when localStorage throws', async () => {
        const error = new Error('Storage error')
        jest.spyOn(localStorage, 'removeItem').mockImplementation(() => { throw error })
    ...
    describe('clear', () => {
      ...
      it('should throw error when localStorage throws', async () => {
        const error = new Error('Storage error')
        jest.spyOn(localStorage, 'clear').mockImplementation(() => { throw error })
  ...
  describe('Native Platform', () => {
    ...
    describe('getItem', () => {
      ...
      it('should throw error when SecureStore throws', async () => {
        ...
        expect(mockGetItem).toHaveBeenCalledWith(testKey)
        expect(mockGetItem).toHaveBeenCalledTimes(1)
        expect(console.error).toHaveBeenCalledWith('Error reading from storage:', expect.any(Error))
      })
    })
    ...
    describe('setItem', () => {
      ...
      it('should throw error when SecureStore throws', async () => {
        ...
        await expect(secureStorageClient.setItem(testKey, testValue)).rejects.toThrow('SecureStore error')
        expect(mockSetItem).toHaveBeenCalledWith(testKey, testValue)
        expect(mockSetItem).toHaveBeenCalledTimes(1)
    ...
    describe('clear', () => {
      ...
      it('should throw error when clearing fails', async () => {
        const warnSpy = jest.spyOn(console, 'warn')
        warnSpy.mockImplementationOnce(() => { throw new Error('Clear error') })
